...
import com.cheng.shiro.AccountRealm;
import com.cheng.shiro.JwtFilter;
...
/**
 * @Author: ChengJun
 * @CreateDate: 2021/7/24 17:39
 * shiro启用注解拦截控制器
 *
 * 1、引入RedisSessizonDAO和RedisCacheManager，为了解决shiro的权限数据和会话信息能保存到redis中，实现会话共享。
